...
# Converting character to date in 'Date' column
...
with(subset_data, {
    ...
    plot(Time, Global_reactive_power, type = "l", main = "", ylab = "Global_reactive_power", xlab = "datetime")
})
dev.off()

print("Done. File plot4.png created.")
